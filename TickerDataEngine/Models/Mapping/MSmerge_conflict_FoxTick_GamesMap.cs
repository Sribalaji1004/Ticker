...
{
    public class MSmerge_conflict_FoxTick_GamesMap : EntityTypeConfiguration<MSmerge_conflict_FoxTick_Games>
    {
        public MSmerge_conflict_FoxTick_GamesMap()
        {
            // Primary Key
            ...
            this.ToTable("MSmerge_conflict_FoxTick_Games");
