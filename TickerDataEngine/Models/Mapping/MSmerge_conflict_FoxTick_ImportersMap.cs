...
{
    public class MSmerge_conflict_FoxTick_ImportersMap : EntityTypeConfiguration<MSmerge_conflict_FoxTick_Importers>
    {
        public MSmerge_conflict_FoxTick_ImportersMap()
        {
            // Primary Key
            ...
            this.ToTable("MSmerge_conflict_FoxTick_Importers");
