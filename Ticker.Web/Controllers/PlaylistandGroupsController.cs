...
{
    public class PlaylistAndGroupsController : ApiController
    {
        private FoxTickerEntities db = new FoxTickerEntities();

        // GET api/Playlist
        //public IEnumerable<Playlist> GetPlaylists()
        public DataSourceResult GetPlaylistAndGroups([ModelBinder(typeof(Ticker.ModelBinders.DataSourceRequestModelBinder))] DataSourceRequest request)
        {
